        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="input-group">
                        <label class="checkbox-inline"><input class='filter' type="checkbox" value="보옥"
                                checked>보옥</label>
                        <label class="checkbox-inline"><input class='filter' type="checkbox" value="지은"
                                checked>지은</label>
                        <label class="checkbox-inline"><input class='filter' type="checkbox" value="아라"
                                checked>아라</label>
                        <label class="checkbox-inline"><input class='filter' type="checkbox" value="일현"
                                checked>일현</label>
                        <label class="checkbox-inline"><input class='filter' type="checkbox" value="민준"
                                checked>민준</label>
                        <label class="checkbox-inline"><input class='filter' type="checkbox" value="희민"
                                checked>희민</label>        
                    </div>
                </div>
